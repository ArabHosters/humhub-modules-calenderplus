 ...
 */
class CalendarPlusEntryParticipant extends HActiveRecord
{
     ...
     * @return CalendarPlusEntryParticipant the static model class
     */
    ...
    {
        return array(
            'calendar_entry' => array(self::BELONGS_TO, 'CalendarPlusEntry', 'calendar_entry_id'),
        );
    }
